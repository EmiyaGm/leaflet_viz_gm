    ...
    L.MarkerClusterGroup = L.FeatureGroup.extend({
        options: {
            ...
            if (t < 10) {
                ...
                i += 'medium';
                return new L.DivIcon({ html: '<div><span>' + t + '</span></div>', className: 'marker-cluster' + i, iconSize: new L.Point(48, 48) });
            } else {
                i += 'large';
                return new L.DivIcon({ html: '<div><span>' + t + '</span></div>', className: 'marker-cluster' + i, iconSize: new L.Point(60, 60) });
            }
